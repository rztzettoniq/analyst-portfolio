...
Схемы в нотации, близкой к BPMN (дорожки по ролям, шлюзы, события), нарисованы в Mermaid, чтобы GitHub показывал их без внешних инструментов. Оригиналы в draw.io лежат в папке `diagrams/` (экспорт в PNG прилагается).
